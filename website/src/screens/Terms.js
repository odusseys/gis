  ...
  return (
    <div style={{ padding: 30 }}>
      ...
      <p>
        ...
        are an agreement between Mobile Application Developer (&quot;Mobile
        Application Developer&quot;, &quot;us&quot;, &quot;we&quot; or
        &quot;our&quot;) and you (&quot;User&quot;, &quot;you&quot; or
        &quot;your&quot;). This Agreement sets forth the general terms and
        conditions of your use of the Kiki mobile application and any of its
      ...
      <p>
        You must be at least 18 years of age to use this Mobile Application. By
        using this Mobile Application and by agreeing to this Agreement you
        warrant and represent that you are at least 18 years of age. If you
        create an account in the Mobile Application, you are responsible for
        ...
        taken in connection with it. Providing false contact information of any
        kind may result in the termination of your account. You must immediately
        notify us of any unauthorized uses of your account or any other breaches
        of security. We will not be liable for any acts or omissions by you,
      ...
      <p>
        ...
        that you submit in the Mobile Application in the course of using the
        ...
        property ownership or right to use of all submitted Content. We may, but
        have no obligation to, monitor Content in the Mobile Application
        submitted or created using our Services by you. Unless specifically
        permitted by you, your use of the Mobile Application does not grant us
        ...
        marketing or any similar purpose. But you grant us permission to access,
        ...
        that, in our reasonable opinion, violates any of our policies or is in
      ...
      <p>
        ...
        jurisdiction may not access such content. If we learn that anyone under
        the age of 18 seeks to conduct a transaction through the Services, we
        will require verified parental consent, in accordance with the
        Children's Online Privacy Protection Act of 1998 (&quot;COPPA&quot;).
        Certain areas of the Mobile Application may not be available to children
      ...
      <p>
        ...
        In no event shall we be held liable for any loss of any Content. It is
      ...
      <p>
        Although this Mobile Application may be linked to other mobile
        applications, we are not, directly or indirectly, implying any approval,
        association, sponsorship, endorsement, or affiliation with any linked
        mobile application, unless specifically stated herein. We are not
        ...
        mobile applications. We do not assume any responsibility or liability
        ...
        other conditions of use of any mobile application which you access
        through a link from this Mobile Application. Your linking to any other
      ...
      <p>
        During use of the Mobile Application, you may enter into correspondence
        with or participate in promotions of advertisers or sponsors showing
        their goods or services through the Mobile Application. Any such
        ...
        third-party. We shall have no liability, obligation or responsibility
      ...
      <p>
        ...
        prohibited from using the Mobile Application or its Content: (a) for any
      ...
      <p>
        ...
        (a): any indirect, incidental, special, punitive, cover or consequential
        ...
        negligence or otherwise, even if Mobile Application Developer has been
        ...
        aggregate liability of Mobile Application Developer and its affiliates,
        ...
        amounts actually paid in cash by you to Mobile Application Developer for
        the prior one month period prior to the first event or occurrence giving
      ...
      <p>
        ...
        the terms of this Agreement, you are not authorized to use or access the
      ...
      <p>This document was last updated on March 1, 2019</p>
    </div>
  );
};
